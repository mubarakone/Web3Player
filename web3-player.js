...
let user
 ...
 <style>
    ...
    .btn-login{
        display: block; left: 100%; margin: 0 auto; padding: 19px 14px; position: absolute; right: 0; top: 40%; font-size: 18px; font-weight: bold; z-index: 1;
    }
    .payToPlay{
        display: block; left: 10%; margin: 0 auto; padding: 19px 14px; position: absolute; right: 0; top: 40%; font-size: 18px; font-weight: bold; z-index: 1;
    }
 </style>
 <div>
 ...
 class web3Video extends HTMLElement {
     ...
     switchOut(){
         ...
         const show = this.shadowRoot.querySelector("#btn-login");
         const hide = this.shadowRoot.querySelector("#btn-logout")
         if(!this.showinfo){
             logOut()
